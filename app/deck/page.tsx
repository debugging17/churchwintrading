...
import { Slide15DigitalVisibilityGap } from "./slides/Slide15DigitalVisibilityGap";
  ...
  return (
    <main className="h-screen w-full overflow-hidden bg-brand-navy relative">
      ...
      >
        ...
        <SwiperSlide>{({ isActive }) => <Slide15DigitalVisibilityGap isActive={isActive} />}</SwiperSlide>
