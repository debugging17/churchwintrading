...
export function Slide07VPCSegments({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="w-full h-full flex flex-col py-6 md:py-8 px-8 md:px-20 bg-brand-cream pb-[calc(var(--footer-height)+2rem)] pt-[calc(4rem+var(--header-height,0px))] md:pt-[calc(5rem+var(--header-height,0px))] overflow-y-auto relative">
