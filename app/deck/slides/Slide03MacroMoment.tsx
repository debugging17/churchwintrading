...
export function Slide03MacroMoment() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center p-8 md:p-12 relative overflow-hidden bg-brand-navy">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="text-center mb-12 max-w-4xl">
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-black text-brand-white leading-tight mb-4 tracking-tighter shadow-2xl">
            Africa had the lead in 1960. 
            <br />
            <span className="text-brand-orange text-shadow-lg italic">Then the divergence began.</span>
          </h2>
          <p className="font-primary text-xl md:text-2xl text-brand-white/80 font-light mt-6 mx-auto max-w-2xl px-6 py-3 bg-brand-orange/10 backdrop-blur-md rounded-full border border-brand-orange/20">
        ...
        <motion.div 
          variants={fadeUp}
          className="w-full aspect-video md:aspect-auto md:h-[50vh] bg-brand-white/95 backdrop-blur-2xl rounded-3xl p-8 md:p-12 shadow-[0_30px_100px_rgba(0,0,0,0.5)] border border-white/20 relative"
        >
          <div className="absolute top-8 left-12">
             <p className="text-[10px] font-display font-black tracking-[0.4em] text-brand-navy/30 uppercase">GDP PER CAPITA (USD)</p>
          </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 40, right: 30, left: 20, bottom: 20 }}>
              ...
              <YAxis hide={true} />
              <Tooltip 
                contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 20px 40px rgba(0,0,0,0.1)', fontFamily: 'var(--font-primary)' }}
          ...
          <motion.div 
            ...
            transition={{ delay: 2 }}
            className="absolute top-1/2 right-12 md:right-24 -translate-y-[20%] w-64 md:w-80 p-6 bg-brand-navy shadow-3xl rounded-2xl border-l-[6px] border-brand-orange z-20"
          >
            <h4 className="font-display font-black text-brand-orange text-lg mb-2 uppercase tracking-widest">The Divergence</h4>
            <p className="font-primary text-brand-white/80 text-sm leading-relaxed">
              ...
              <br /><br />
              <span className="text-brand-orange font-bold uppercase text-[10px]">Churchwin Mandate:</span>
              <br />
        ...
        <motion.p variants={fadeUp} className="mt-8 text-[10px] font-display font-black tracking-[0.4em] text-brand-white/30 uppercase">
