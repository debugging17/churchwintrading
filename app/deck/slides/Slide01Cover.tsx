...
export function Slide01Cover({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="w-full h-full flex flex-col relative bg-brand-navy pb-[calc(var(--footer-height)+2rem)] pt-[calc(4rem+var(--header-height,0px))] md:pt-[calc(5rem+var(--header-height,0px))] overflow-y-auto">
      ...
      <div className="w-full h-full flex flex-col justify-start items-center pt-24 md:pt-32 lg:pt-40 px-10 md:px-24 z-10 relative text-center">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="mb-6">
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-display font-black text-brand-white leading-tight tracking-tight drop-shadow-2xl uppercase max-w-5xl">
          ...
          <motion.div variants={fadeUp} className="flex flex-col items-center">
             ...
             <p className="text-sm md:text-base lg:text-lg text-brand-white/90 font-primary font-bold tracking-[0.3em] drop-shadow-lg uppercase px-4">
